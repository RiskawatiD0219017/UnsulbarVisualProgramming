...
window = Tk()
window.title("===Kalkulator Riskawati===")
window.geometry('400x200')

label1 = Label(window,text="Masukkan Nilai 1 : ",anchor="e", width=20)
label1.grid(column=0, row=0)

nilai1 = Entry(window,width=10)
nilai1.grid(column=1,row=0)

label2 = Label(window,text="Masukkan Nilai 2 : ",anchor="e", width=20)
